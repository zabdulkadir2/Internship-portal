...
const initStudentProfile = async () => {
    try {
        ...
        console.error('Student profile initialization error:', error);
        hideLoadingState();
...
const loadProfileData = async () => {
    try {
        ...
        if (userData.role !== 'student') {
            console.warn('User is not a student, redirecting to appropriate dashboard');
...
const populateFormFields = (userData) => {
    const fieldMappings = {
        ...
        'university': userData.university || userData.program || '',
        'bio': userData.bio || ''
    };
...
const showLoadingState = () => {
    ...
    // Add loading class to body for any additional styling
...
const hideLoadingState = () => {
    ...
    setTimeout(() => {
        ...
        if (contentElement) {
            ...
            // Add transition class for smooth entrance
...
document.addEventListener('DOMContentLoaded', initStudentProfile);